...
async def create_user_api_users_post(data: UserInCreate, api_config_override: Optional[APIConfig] = None) -> UserOut:
...
async def get_me_api_users_me_get(api_config_override: Optional[APIConfig] = None) -> UserOut:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def update_user_api_users_me_patch(
    data: UserInUpdate, api_config_override: Optional[APIConfig] = None
) -> UserOut:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def search_user_api_users_search_post(
