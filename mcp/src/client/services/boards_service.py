...
def list_boards_boards_get(api_config_override: Optional[APIConfig] = None) -> List[BoardOut]:
...
def create_board_boards_post(data: BoardInCreate, api_config_override: Optional[APIConfig] = None) -> BoardOut:
    api_config = api_config_override if api_config_override else APIConfig()
...
def get_board_boards__board_id__get(board_id: int, api_config_override: Optional[APIConfig] = None) -> BoardOut:
    api_config = api_config_override if api_config_override else APIConfig()
...
def delete_board_boards__board_id__delete(board_id: int, api_config_override: Optional[APIConfig] = None) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
...
def update_board_boards__board_id__patch(
...
def list_cards_boards__board_id__cards_get(
...
def create_cards_boards__board_id__cards_post(
...
def share_board_boards__board_id__users__user_id__put(
...
def unshare_board_boards__board_id__users__user_id__delete(
    user_id: int, board_id: int, api_config_override: Optional[APIConfig] = None
) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
