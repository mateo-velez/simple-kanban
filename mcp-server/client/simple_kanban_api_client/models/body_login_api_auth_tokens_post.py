...
T = TypeVar("T", bound="BodyLoginApiAuthTokensPost")


@_attrs_define
class BodyLoginApiAuthTokensPost:
    """
    Attributes:
        username (str):
        password (str):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        body_login_api_auth_tokens_post = cls(
            username=username,
            password=password,
        ...
        body_login_api_auth_tokens_post.additional_properties = d
        return body_login_api_auth_tokens_post
